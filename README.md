...
# Documentation
Documentation for all individual components of the extFramework are included in the `docs` folder, documentation is formatted using [MkDocs](https://www.mkdocs.org/), which can be recompiled using the guide [here](https://www.mkdocs.org/getting-started/).
